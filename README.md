# pykimai
pykimai is based on kimai-python, which is more or less inactive at this point.  I decided to fork and make updates and bugfixes instead of monkeypatching to revive the tool. Much of the documentation will match the original repo while I work through updates the content.  I will start with manual fixes while I recreate the swagger configuration. 
